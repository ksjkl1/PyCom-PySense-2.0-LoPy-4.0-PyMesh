...
class Lorawan:
    ...
    def __init__(self):
        ...
        self.dev_eui = binascii.unhexlify('007C3D5025FA3EC9')
        self.app_eui = binascii.unhexlify('70B3D57ED00423AE')
        self.app_key = binascii.unhexlify('367FD9CC8E1EEEE24AB07B7E00B1D2F9')
